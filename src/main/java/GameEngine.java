public class GameEngine {
    ...
    public GuessResult makeGuess(int guess) {
        ...
        if (guess == target) {
            ...
            return new GuessResult(false, "Too low! Try a higher number." + getHint(guess), attempts);
        } else {
            return new GuessResult(false, "Too high! Try a lower number." + getHint(guess), attempts);
        }
    }
