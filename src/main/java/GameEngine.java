public class GameEngine {
    ...
    public GuessResult makeGuess(int guess) {
        ...
        if (guess == target) {
            ...
            GuessResult result;
            if (guess < target) {
                result = new GuessResult(false, "Too low! Try a higher number." + getHint(guess), attempts);
            } else {
                result = new GuessResult(false, "Too high! Try a lower number." + getHint(guess), attempts);
            }
